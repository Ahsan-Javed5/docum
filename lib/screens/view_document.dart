...
class _ViewDocumentState extends State<ViewDocument>
  ...
  void getDirectoryData({
    ...
    int index = 1;
    directoryData =
        await database.getDirectoryData(widget.directoryOS.dirName!);
  ...
  Future<void> createDirectoryPath() async {
    ...
    String dirPath = "${appDir?.path}/Docum ${DateTime.now()}";
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            onTap: () {
              ...
              Share.shareXFiles(
                (enableSelect)
                    ? selectedImagesPath.map((e) => XFile(e)).toList()
                    : imageFilesPath.map((e) => XFile(e)).toList(),
              );
              Navigator.pop(context);
            },
          ),
